...
import { getCachedAggregates } from '@/lib/transform.mjs';
...
export default function Dashboard({ data }: Props) {
  return (
    <>
      <Head>
        <title>APPG Benefits Dashboard</title>
        <meta name="description" content="Analysis of All-Party Parliamentary Group benefits over time" />
      </Head>
